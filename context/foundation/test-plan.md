...
| --- | --------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ------------------ | ----------- | ------------------------------------------------- |
| 1   | Critical-path authorization & immutability coverage | Bootstrap the test runner and defend the two highest-impact core guarantees: cross-group visibility and the 24h lock boundary    | #1, #2             | unit + integration | implemented | `context/changes/testing-critical-path-coverage/` |
